...
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\collegescorecard.csv]
...
LOAD CCSIZSET, 
     [Class Size]
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is [class size]);

DegreeOffered:
NoConcatenate
LOAD PREDDEG, 
     [Major Degree Offered]
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is degree);
...
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is [highest degree]);
...
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is urbanization);
...
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is classification);
...
FROM
[C:\Users\jchen\Documents\Testing\R\medical school\data\lookup.xlsx]
(ooxml, embedded labels, table is biology);
